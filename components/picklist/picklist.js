...
PickList.propDecorators = {
    ...
    'sourceHeader': [{ type: core_1.Input },],
    'targetHeader': [{ type: core_1.Input },],
    ...
    'sourceStyle': [{ type: core_1.Input },],
    'targetStyle': [{ type: core_1.Input },],
    'showSourceControls': [{ type: core_1.Input },],
    'showTargetControls': [{ type: core_1.Input },],
    'sourceFilterPlaceholder': [{ type: core_1.Input },],
    'targetFilterPlaceholder': [{ type: core_1.Input },],
    'onMoveToSource': [{ type: core_1.Output },],
    'onMoveAllToSource': [{ type: core_1.Output },],
    'onMoveAllToTarget': [{ type: core_1.Output },],
    'onMoveToTarget': [{ type: core_1.Output },],
    'onSourceReorder': [{ type: core_1.Output },],
    'onTargetReorder': [{ type: core_1.Output },],
    'listViewSourceChild': [{ type: core_1.ViewChild, args: ['sourcelist',] },],
    'listViewTargetChild': [{ type: core_1.ViewChild, args: ['targetlist',] },],
