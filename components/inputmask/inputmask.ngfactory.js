...
function View_InputMask_0(_l) {
    return i0.ɵvid(0, [i0.ɵqud(402653184, 1, { inputViewChild: 0 }), (_l()(), i0.ɵeld(0, [[1,
                ...
                0], [8, 'disabled', 0], [8, 'readOnly', 0], [2, 'ui-inputtext', null], [2, 'ui-corner-all',
                null], [2, 'ui-state-default', null], [2, 'ui-widget', null],
            [2, 'ui-state-filled', null]], [[null, 'focus'], [null,
                'blur'], [null, 'keydown'], [null, 'keypress'], [null,
                'input'], [null, 'paste']], function (_v, en, $event) {
            var ad = true;
        ...
        var _co = _v.component;
        var currVal_14 = _co.styleClass;
        _ck(_v, 2, 0, currVal_14);
        var currVal_15 = _co.style;
        ...
        var currVal_11 = true;
        var currVal_12 = true;
        var currVal_13 = i0.ɵnov(_v, 4).filled;
...
exports.InputMaskNgFactory = i0.ɵccf('p-inputMask', i1.InputMask, View_InputMask_Host_0, { mask: 'mask', type: 'type', slotChar: 'slotChar',
    autoClear: 'autoClear', style: 'style', inputId: 'inputId', styleClass: 'styleClass',
    placeholder: 'placeholder', size: 'size', maxlength: 'maxlength', tabindex: 'tabindex',
    disabled: 'disabled', readonly: 'readonly', unmask: 'unmask', name: 'name' }, { onComplete: 'onComplete',
